...
K_MSGQ_DEFINE(alertQueue, sizeof(char[NAlerts::ALERT_PACKET_SIZE]), 10, 4);
static auto alertMsgQueue = CMsgqMessagePort<char[NAlerts::ALERT_PACKET_SIZE]>(alertQueue);
