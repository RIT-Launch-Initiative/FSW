...
//    radioBroadcastData.size = static_cast<uint8_t>(rcvResult);
    ...
    uint16_t portOne = 13100;
    uint16_t portTwo = 11015;

    radioBroadcastData.port = 12999;
    radioBroadcastData.size = 4;
    radioBroadcastData.data[0] = portOne >> 8;
    radioBroadcastData.data[1] = portOne & 0xFF;
    radioBroadcastData.data[2] = portTwo >> 8;
    radioBroadcastData.data[3] = portTwo & 0xFF;
