...
class CMSISMatrix {
  public:
    ...
    constexpr CMSISMatrix(std::array<std::array<Scalar, C>, R> init) {
    ...
    static constexpr CMSISMatrix Zeros() {
        CMSISMatrix m;
    ...
    static constexpr CMSISMatrix Identity() {
    ...
    static constexpr CMSISMatrix Column(const std::array<Scalar, R> list) {
