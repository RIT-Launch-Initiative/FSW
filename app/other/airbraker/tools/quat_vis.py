...
class Window(Qt3DExtras.Qt3DWindow):
    def __init__(self):
        ...
        self.camera().setPosition(QVector3D(10, 10, 40))
    ...
    def createScene(self):
        ...
        # self.torusTransform.setRotation(QQuaternion.fromAxisAndAngle(QVector3D(1, 0, 0), 0))

        self.torusEntity.addComponent(self.planeMesh)
