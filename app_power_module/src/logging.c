...
K_MSGQ_DEFINE(adc_logging_msgq, sizeof(timed_adc_data), 200, 4);
...
static void send_last_log(const uint32_t boot_count_to_get) {
    ...
    l_fs_file_t adc_file = {
        .fname = adc_file_name,
        .width = sizeof(timed_adc_data),
        .mode = SLOG_ONCE,
        .size = sizeof(timed_adc_data) * ADC_SAMPLE_COUNT,
        .initialized = false,
        .file = {0},
        .dirent = {0},
        .vfs = {0},
    ...
    timed_adc_data adc_data[ADC_SAMPLE_COUNT] = {{}};
