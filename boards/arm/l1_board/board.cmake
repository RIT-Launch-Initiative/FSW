...
# Set L1_BOARD_DEBUG_ADAPTER to select debug adapter by command-line arguments.
# e.g.) west build -b rpi_pico -- -DL1_BOARD_DEBUG_ADAPTER=raspberrypi-swd
...
if("${L1_BOARD_DEBUG_ADAPTER}" STREQUAL "")
	set(L1_BOARD_DEBUG_ADAPTER "cmsis-dap")
endif()

board_runner_args(openocd --cmd-pre-init "source [find interface/${L1_BOARD_DEBUG_ADAPTER}.cfg]")
