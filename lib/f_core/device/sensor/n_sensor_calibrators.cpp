...
static TargetMg accelTargetFromOrientation(NSensorCalibrators::GravityOrientation orientation) {
    switch (orientation) {
        case NSensorCalibrators::GravityOrientation::PosX:
            return {.xMg = +1000, .yMg = 0, .zMg = 0};
        case NSensorCalibrators::GravityOrientation::NegX:
            return {.xMg = -1000, .yMg = 0, .zMg = 0};
        case NSensorCalibrators::GravityOrientation::PosY:
            return {.xMg = 0, .yMg = +1000, .zMg = 0};
        case NSensorCalibrators::GravityOrientation::NegY:
            return {.xMg = 0, .yMg = -1000, .zMg = 0};
        case NSensorCalibrators::GravityOrientation::PosZ:
            return {.xMg = 0, .yMg = 0, .zMg = +1000};
        case NSensorCalibrators::GravityOrientation::NegZ:
            return {.xMg = 0, .yMg = 0, .zMg = -1000};
        default:
            return {0, 0, +1000};
    }
...
static bool resetAccelerometerOffsets(CAccelerometer& accelerometer) {
    ...
    const sensor_value xyzArray[] = {zeroOffset, zeroOffset, zeroOffset};
...
bool NSensorCalibrators::CalibrateADXL375(CAccelerometer& accelerometer, uint16_t nSamples,
